...
export default {
            ...
            .then(() => {
                ...
                uni.$on('payment', (params) => {
                    setTimeout(() => {
                        ...
                        if (params.result) {
                            uni.redirectTo({
                                url: `/bundle_order/pages/pay_result/pay_result?id=${params.order_id}`
                            })
                        } else {
                            uni.redirectTo({
    ...
    methods: {
        ...
        onAddressExpress() {
            uni.navigateTo({
                url: `/bundle_user/pages/user_address/user_address?type=${1}`
            })
        },
        ...
        onAddressStore() {
            uni.navigateTo({
                url: `/bundle_user/pages/store_list/store_list`
            })
        },
        ...
        async handleOrderSubmit(from) {
            ...
            try {
                ...
                if (code == 1) {
                    uni.redirectTo({
                        url: `/bundle_order/pages/payment/payment?from=${data.type}&order_id=${data.order_id}`
                    })
                } else {
                    throw new Error(msg)
                }
