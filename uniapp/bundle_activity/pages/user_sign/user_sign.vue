        ...
        <view class="row">
            ...
            <view class="white ml20 row-between" style="flex: 1">
                <view>
                    ...
                    <view class="row">
                        <navigator class="sm row" hover-class="none" url="/bundle_activity/pages/sign_rule/sign_rule">
                            我的积分
                            <image src="../../static/images/jifen_icon_help.png" class="icon-sm ml10"></image>
                        </navigator>
                    </view>
                </view>
                <navigator class="score-detail-entry row" url="/bundle_activity/pages/sign_detail/sign_detail" hover-class="none">
