<template>
    <view class="login">
        ...
        <view class="mpwx-login">
            ...
            <view class="agreement-row sm row-start mt20" style="width: 100%">
                <view class="agreement-check-hit row-center" @tap="changeChecked">
                    <view class="agreement-check row-center" :class="{ checked: isAgree }">
                        <text v-if="isAgree">✓</text>
                    </view>
                </view>
                <view class="agreement-copy row-start wrap">
                    <text>已阅读并同意</text>
                    <navigator
                        @tap.stop=""
                        class="primary agreement-link"
                        hover-class="none"
                        url="/bundle_order/pages/server_explan/server_explan?type=0"
                    >
                        《服务协议》
                    </navigator>
                    <text>和</text>
                    <navigator
                        ...
                        class="primary agreement-link"
                        hover-class="none"
                        url="/bundle_order/pages/server_explan/server_explan?type=1"
                    >
                        《隐私协议》
                    </navigator>
                </view>
        ...
        <view class="account-login">
            ...
            <block v-if="isPhonelogin == 1">
                ...
                <view class="agreement-row sm row-start mb20 mt20" style="width: 100%">
                    <view class="agreement-check-hit row-center" @tap="changeChecked">
                        <view class="agreement-check row-center" :class="{ checked: isAgree }">
                            <text v-if="isAgree">✓</text>
                        </view>
            ...
            <block v-if="isPhonelogin == 0">
                <view>
                        ...
                        <view class="input row" style="padding: 15rpx">
                            ...
                            <navigator
                                style="
                                    ...
                                    padding-left: 30rpx;
                                "
                                url="/bundle_user/pages/forget_pwd/forget_pwd"
                                hover-class="none"
                                >忘记密码</navigator
                            >
                        </view>
                    ...
                    <view class="row-between" style="width: 680rpx">
                        ...
                        <navigator class="lighter" url="/bundle_user/pages/register/register" hover-class="none"
                            >注册账号</navigator
                        >
                    </view>
                </view>
...
export default {
    ...
    methods: {
        ...
        async mnpLoginFun() {
            ...
            const needPrivacyAuthorization = await this.checkPrivacySetting()
            if (needPrivacyAuthorization) {
                return
            }
            this.isMnpLoggingIn = true
            try {
            ...
            return new Promise((resolve) => {
                ...
                wx.getPrivacySetting({
                    success: (res) => {
                        ...
                        this.showPrivacyPopup = needAuthorization
...
<style lang="scss">
page {
    background: linear-gradient(180deg, #fff7f8 0%, #ffffff 45%);
    .login {
        height: 100vh;
