    ...
    <view class="main" v-if="!showLoading">
        ...
        <view :hidden="vipState!=2" class="user-vip">
            ...
            <view class="mt20 fans-msg-box row-center bg-white md">
                <navigator url="/bundle_user/pages/user_fans/user_fans" hover-class="none" class="my-fans row-center normal">
            ...
            <view class="usual-tools-box bg-white mt20">
                ...
                <navigator hover-class="none" url="/bundle_user/pages/user_spread_order/user_spread_order" class="usual-item column-center">
                ...
                <navigator hover-class="none" url="/bundle_user/pages/user_spread_month_bill/user_spread_month_bill" class="usual-item column-center">
