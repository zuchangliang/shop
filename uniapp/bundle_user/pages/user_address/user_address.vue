<template>
    <!-- bundle_user/pages/user_address/user_address.wxml -->
...
export default {
    ...
    methods: {
        ...
        addAddress() {
            uni.navigateTo({
                url: '/bundle_user/pages/address_edit/address_edit'
            })
        },

        editAddress(id) {
            uni.navigateTo({
                url: `/bundle_user/pages/address_edit/address_edit?id=${id}`
            })
        },
...
<style lang="scss">
/* bundle_user/pages/user_address/user_address.wxss */
.user-address {
