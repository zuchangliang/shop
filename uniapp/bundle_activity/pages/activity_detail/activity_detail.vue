...
<view class="activity-detail-contain">
        ...
        <view class="content">
            <view class="goods-container">
                    <navigator v-for="(item, index) in goodsList" :key="index" :url="'/bundle_activity/pages/goods_details/goods_details?id=' + item.id" class="goods-item bg-white row mb10" hover-class="none">
