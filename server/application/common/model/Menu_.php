...
class Menu_{
    ...
    public static function getMenuContent($scene = true,$from = true){
        ...
        $config1 = [
            self::index_seckill            => [
                'name'          => '限时秒杀',
                'link'          => '/bundle_activity/pages/goods_seckill/goods_seckill',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_team_activity      => [
                'name'          => '拼团活动',
                'link'          => '/bundle_activity/pages/goods_combination/goods_combination',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_hot_sell           => [
                'name'          => '热销榜单',
                'link'          => '/bundle_activity/pages/hot_list/hot_list',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_coupon_list        => [
                'name'          => '领券中心',
                'link'          => '/bundle_user/pages/user_getcoupon/user_getcoupon',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_sign_in            => [
                'name'          => '积分签到',
                'link'          => '/bundle_activity/pages/user_sign/user_sign',
                'is_tab'        => 0,
                'menu_type'     => 1,
            ],
            self::index_member_centre      => [
                'name'          => '会员中心',
                'link'          => '/bundle_user/pages/user_vip/user_vip',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_my_collect         => [
                'name'          => '我的收藏',
                'link'          => '/bundle_user/pages/user_collection/user_collection',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_store_news         => [
                'name'          => '商城资讯',
                'link'          => '/bundle_activity/pages/news_list/news_list',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_store_help         => [
                'name'          => '帮助中心',
                'link'          => '/bundle_activity/pages/news_list/news_list?type=1',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_delivery_address   => [
                'name'          => '收货地址',
                'link'          => '/bundle_user/pages/user_address/user_address',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            ...
            self::index_luckdraw           => [
                'name'          => '积分抽奖',
                'link'          => '/bundle_activity/pages/luckly_wheel/luckly_wheel',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_bargain            => [
                'name'          => '砍价活动',
                'link'          => '/bundle_activity/pages/bargain/bargain',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_live_room           => [
                'name'          => '商城直播',
                'link'          => '/bundle_activity/pages/live_broadcast/live_broadcast',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
        ...
        $config2 = [
            self::centre_my_wallet         => [
                'name'          => '我的钱包',
                'link'          => '/bundle_user/pages/user_wallet/user_wallet',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::centre_generalize        => [
                'name'          => '分销推广',
                'link'          => '/bundle_user/pages/user_spread/user_spread',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 2,
            ],
            self::centre_my_coupon         => [
                'name'          => '我的优惠券',
                'link'          => '/bundle_user/pages/user_coupon/user_coupon',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            ...
            self::centre_service            => [
                'name'          => '联系客服',
                'link'          => '/bundle_order/pages/contact_offical/contact_offical',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::centre_team_activity      => [
                'name'          => '我的拼团',
                'link'          => '/bundle_activity/pages/user_group/user_group',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::centre_bargain            => [
                'name'          => '砍价记录',
                'link'          => '/bundle_activity/pages/bargain_code/bargain_code',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::centre_writeoff_order     => [
                'name'          => '核销订单',
                'link'          => '/bundle_user/pages/writeoff_order/writeoff_order',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::centre_invitation_poster => [
                'name'          => '邀请海报',
                'link'          => '/bundle_user/pages/invite_fans/invite_fans',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ]
