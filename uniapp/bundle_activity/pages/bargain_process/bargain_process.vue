<template>
    <view class="bargain-process-container">
        ...
        <view v-show="status == -1">
            ...
            <view class="main">
                <navigator class="goods-planel row" :url="'/bundle_activity/pages/goods_details/goods_details?id=' + activityObj.goods_id" hover-class="none">
        ...
        <view v-show="status != -1">
            ...
            <view class="main">
                <navigator class="goods-planel row" :url="'/bundle_activity/pages/goods_details/goods_details?id=' + bargainObj.goods_id" hover-class="none">
                ...
                <view class="shared-panel" v-if="status == 5" >
                    <view class="btn-container">                        
                        ...
                        <navigator hover-class="none" url="/bundle_activity/pages/bargain/bargain" class="knife-btn row-center lg normal br60" v-if="bargainObj.sponsor_btn">
                            我也要砍价
                        </navigator>
                    </view>
                    <view class="code-content">
       ...
       <!-- <share-popup 
		...
		<share-popup 
			...
			:share-id="bargainId"
			pagePath="bundle_activity/pages/bargain_process/bargain_process" 
			:config="{
...
<script>
    ...
    export default {
        ...
        onShareAppMessage() {
            return {
                path: "bundle_activity/pages/bargain_process/bargain_process?bargainId=" + this.bargainId,
        ...
        methods: {
            ...
            toOrderDetail() {
                uni.navigateTo({
                    url: "/bundle_order/pages/order_details/order_details?id=" + this.bargainObj.order_id
                })
            },
            ...
            handleClickBuy() {
                ...
                uni.navigateTo({
                   url: '/bundle_order/pages/confirm_order/confirm_order?data=' + encodeURIComponent(JSON.stringify(params)) + "&bargain_launch_id=" + this.bargainObj.id
                })
            }
        }
    }
