<template>
	<view class="luckly-wheel-container">
		...
		<view class="main">
			<view class="row-end">
				<navigator class="user-prize row-center" url="/bundle_activity/pages/prize_record/prize_record"
					hover-class="none">
                ...
                <text class="xs marquee_text" style="color: #F9EDDD;" wx:for="{{record}}" wx:key="id">{{item.text}}</text>
					...
					<view class="message row-between nr">
						...
						<template v-if="config.show_win">
							<navigator class="row" url="/bundle_activity/pages/win_prize_code/win_prize_code"
								hover-class="none">
