...
class GoodsOneSpec extends Validate
{
    protected $rule = [
        ...
        'one_unit_count'   => 'require|integer|gt:0',
        'one_unit_price'   => 'require|egt:0.01',
        'one_price'        => 'require|egt:0.01',
        'one_unit_cost_price' => 'require|egt:0.01',
...
//        'one_market_price.require'  => '请输入市场价',
        ...
        'one_unit_count.require'    => '请输入内含件数',
        'one_unit_count.integer'    => '内含件数必须为整数',
        'one_unit_count.gt'         => '内含件数必须大于0',
        'one_unit_price.require'    => '请输入单价',
        'one_unit_price.egt'        => '单价必须大于或等于0.01',
        'one_price.require'         => '请输入价格',
        'one_price.egt'              => '价格必须大于或等于0.01',
        'one_unit_cost_price.require' => '请输入单件成本价',
        'one_unit_cost_price.egt'    => '单件成本价必须大于或等于0.01',
