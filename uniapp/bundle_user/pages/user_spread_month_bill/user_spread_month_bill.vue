    ...
    <view v-for="(item, index) in orderList" :key="index">
        ...
        <view class="show-panel row">
            ...
            <view class="panel-item column-center" style="align-self: flex-end;">
                <navigator hover-class="none" :url="'/bundle_user/pages/user_spread_month_bill_detail/user_spread_month_bill_detail?year=' + item.year + '&month=' + item.month" class="row lighter">
