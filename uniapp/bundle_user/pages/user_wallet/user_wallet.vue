    ...
    <view class="contain bg-white mb20">
        <view class="header">
            ...
            <view class="money white row">
                ...
                <navigator v-if="wallet.open_racharge" style="height: 58rpx;" hover-class="none" url="/bundle_user/pages/user_payment/user_payment" class="row-center primary bg-white br60 btn" size="xs">充值</navigator>
            </view>
        </view>
        <view class="nav row">
			<navigator class="nav-item column-center" hover-class="none" url="/bundle_user/pages/balance_transfer/balance_transfer">
			    <image src="../../static/images/icon_yezz.png"></image>
			    <view class="mt10">余额转账</view>
			</navigator>
            <navigator class="nav-item column-center" hover-class="none" url="/bundle_user/pages/user_bill/user_bill?type=0">
                <image src="../../static/images/icon_zhmx.png"></image>
                <view class="mt10">账户明细</view>
            </navigator>
			
			<navigator class="nav-item column-center" hover-class="none" url="/bundle_user/pages/transfer_record/transfer_record">
			    <image src="../../static/images/icon_zzjl.png"></image>
			    <view class="mt10">转账记录</view>
			</navigator>
            <navigator class="nav-item column-center" hover-class="none" url="/bundle_user/pages/recharge_code/recharge_code">
        ...
        <view class="activity">
            ...
            <view class="activity-item row-between">
                <view>
                    ...
                    <navigator class="br60 bg-primary white join-btn row-center" url="/bundle_activity/pages/user_sign/user_sign" hover-class="none">立即参与</navigator>
                </view>
