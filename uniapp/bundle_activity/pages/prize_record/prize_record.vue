<template>
	<!--bundle_activity/pages/prize_record/prize_record.wxml-->
...
<script>
	// bundle_activity/pages/prize_record/prize_record.js
	import {
		loadingType
	} from '@/utils/type';
	import {
...
<style lang="scss">
	/* bundle_activity/pages/prize_record/prize_record.wxss */
